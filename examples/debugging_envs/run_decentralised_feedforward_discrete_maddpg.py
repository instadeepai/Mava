...
def make_networks(
    ...
    for key in specs.keys():
        ...
        # TODO (dries): Make specs[key].actions return a list of specs for hybrid action space

        # Get total number of action dimensions from action spec.
        if type(specs[key].actions) == DiscreteArray:
            num_act_dimensions = specs[key].actions.num_values
        elif type(specs[key].actions) == BoundedArray:
            num_act_dimensions = np.prod(specs[key].actions.shape, dtype=int)
        else:
        ...
        policy_network = snt.Sequential(
            [
                ...
                networks.NearZeroInitializedLinear(num_act_dimensions),
