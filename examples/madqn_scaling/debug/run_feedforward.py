...
from mava.systems.tf import madqn_scaling
...
def main(_: Any) -> None:
    ...
    # Networks.
    network_factory = lp_utils.partial_kwargs(madqn_scaling.make_default_networks)
    ...
    # distributed program
    program = madqn_scaling.MADQNScaling(
