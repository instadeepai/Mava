...
"""Example running MADDPG on debug MPE environments, using a custom, sparse, \
...
def custom_connected_network_spec(
    ...
    """Network specification for a custom topology

    Args:
        agents_by_type : Agent ids by type
    Returns:
        network specification, for each agent showing their connections
    """
    del agents_by_type

    return {
        "agent_0": ["agent_0", "agent_1"],
        "agent_1": ["agent_1", "agent_0", "agent_2"],
        "agent_2": ["agent_2", "agent_1"],
    }
