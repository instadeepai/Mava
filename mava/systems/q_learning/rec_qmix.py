...
def init(
    ...
    init_hidden_state = ScannedRNN.initialize_carry(
        (cfg.system.n_envs, num_agents), hidden_size
    )  # (1, n_envs, A, x)
    ...
    # Make QMixer
    dummy_agent_qs = jnp.zeros((cfg.system.batch_size, cfg.system.recurrent_chunk_size - 1, num_agents), "float32")
    ...
    dummy_global_env_state = jnp.zeros((cfg.system.batch_size, cfg.system.recurrent_chunk_size - 1, *global_env_state_shape), "float32")
