...
class OfflineMADQNFeedForwardExecutor(MADQNFeedForwardExecutor):
    """A feed-forward executor for offline MADQN.
    An executor based on a Q-function policy for each agent in the system.
    """
