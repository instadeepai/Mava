...
class VDN(MADQN):
    ...
    def __init__(
        ...
        Args:
            ...
            epsilon_min: final minimum epsilon value at the end of a decaying schedule.
                Defaults to 0.05.
            ...
            sequence_length: recurrent sequence rollout length. Defaults
                to 20.
            importance_sampling_exponent: Not implemented yet.
            max_priority_weight: Not implemented yet.
