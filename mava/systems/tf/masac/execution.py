...
class MASACFeedForwardExecutor(executors.FeedForwardExecutor):
    """A feed-forward executor for discrete actions in MASAC.
    ...
    def _policy(
        ...
        # print("Observation", batched_observation)
        policy, _ = self._policy_networks[agent_key](batched_observation)
