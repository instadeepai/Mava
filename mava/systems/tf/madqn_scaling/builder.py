...
from mava.components.tf.modules.exploration import exploration_scheduling
from mava.systems.tf import executors, variable_utils
from mava.systems.tf.madqn_scaling import training
from mava.systems.tf.madqn_scaling.execution import MADQNScalingFeedForwardExecutor
from mava.systems.tf.variable_sources import VariableSource as MavaVariableSource
from mava.utils.sort_utils import sort_str_num
from mava.wrappers import DetailedTrainerStatistics, ScaledDetailedTrainerStatistics
...
class MADQNScalingConfig:
    ...
    exploration_scheduler_fn: Optional[exploration_scheduling.BaseExplorationScheduler] = None
    exploration_scheduler_kwargs: Optional[Dict[str, float]] = None
    checkpoint_subpath: str = "~/mava/"
    termination_condition: Optional[Dict[str, int]] = None


class MADQNScalingBuilder:
    """Builder for scaled MADDPG which constructs individual components of the
    system."""

    def __init__(
        self,
        config: MADQNScalingConfig,
        trainer_fn: Type[training.MADQNScalingTrainer] = training.MADQNScalingTrainer,
        executor_fn: Type[core.Executor] = MADQNScalingFeedForwardExecutor,
    ...
    def make_replay_tables(
        ...
        # Select adder
        env_adder_spec = environment_spec
    ...
    def make_executor(
        ...
        Args:
            networks: policy networks for each agent in
                the system.
        ...
        exploration_scheduler = self._config.exploration_scheduler_fn(**self._config.exploration_scheduler_kwargs)
    ...
    def make_trainer(
        ...
        if issubclass(self._trainer_fn, training.MADQNScalingRecurrentTrainer):
