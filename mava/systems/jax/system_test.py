...
class ComponentZero(MainComponent):
    ...
    def on_building_start(self, builder: SystemBuilder) -> None:
        ...
        """
        builder.attr.int_plus_str = self.config.param_0 + int(self.config.param_1)
...
class ComponentOne(SubComponent):
    ...
    def on_building_start(self, builder: SystemBuilder) -> None:
        ...
        """
        builder.attr.float_plus_bool = self.config.param_2 + float(self.config.param_3)
...
class ComponentTwo(MainComponent):
    ...
    def on_building_start(self, builder: SystemBuilder) -> None:
        ...
        """
        builder.attr.str_plus_bool = int(self.config.param_4) + int(self.config.param_5)
...
def test_system_launch_with_build(
    ...
    assert system_with_two_components._builder.attr.int_plus_str == 3
    assert system_with_two_components._builder.attr.float_plus_bool == 1.2
...
def test_system_update_with_existing_component(
    ...
    assert system_with_two_components._builder.attr.float_plus_bool == 2.2
    assert system_with_two_components._builder.attr.str_plus_bool == 3
...
def test_system_add_with_non_existing_component(
    ...
    assert system_with_one_component._builder.attr.int_plus_str == 2
    assert system_with_one_component._builder.attr.float_plus_bool == 2.2
...
def test_system_update_twice(system_with_two_components: System) -> None:
    ...
    system_with_two_components.build()
    assert system_with_two_components._builder.attr.int_plus_str == 2
    assert system_with_two_components._builder.attr.float_plus_bool == 2.2
...
def test_system_add_twice(system_with_zero_components: System) -> None:
    ...
    assert system_with_zero_components._builder.attr.float_plus_bool == 2.2
    assert system_with_zero_components._builder.attr.str_plus_bool == 3
...
def test_system_build_one_component_params(
    ...
    assert system_with_two_components._builder.attr.int_plus_str == 4
    assert system_with_two_components._builder.attr.float_plus_bool == 2.2
