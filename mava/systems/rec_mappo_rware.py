    ...
    def _update_step(learner_state: RNNLearnerState, _: Any) -> Tuple[RNNLearnerState, Tuple]:
        ...
        Args:
            learner_state (NamedTuple):
                ...
                - hstates (chex.Array): The hidden states of the RNN.
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                actor_params, critic_params = params
                actor_opt_state, critic_opt_state = opt_states
                (
                    init_policy_hstate,
                    init_critic_hstate,
                    traj_batch,
    ...
    def learner_fn(learner_state: RNNLearnerState) -> ExperimentOutput:
        ...
        Args:
            learner_state (NamedTuple):
                ...
                - opt_states (OptState): The initial optimizer states.
