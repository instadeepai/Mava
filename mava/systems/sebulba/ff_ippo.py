...
def rollout(  # noqa: CCR001
    ...
    # Create envs
    envs = make(config)(config.arch.num_envs)
...
def get_learner_fn(
    ...
    def single_device_update(agents_state, traj_batch, last_observation, rng):
        params, opt_states = agents_state
...
def learner_setup(rngs: chex.Array, config: DictConfig, learner_devices) -> None:
    """Initialise learner_fn, network, optimiser, environment and states."""
    # Get number of actions and agents.
    dummy_envs = make(config)(  # Create dummy_envs to get observation and action spaces
    ...
    return multi_device_update, actor_network, agents_state, apply_fns
