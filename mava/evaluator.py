...
def evaluator_setup(
    ...
    n_devices = len(jax.devices())
    win_rate = isinstance(env, (SMAX, HeuristicEnemySMAX, LearnedPolicyEnemySMAX))
    ...
    if use_recurrent_net:
        ...
        evaluator = get_ff_evaluator_fn(eval_env, vmapped_eval_network_apply_fn, config, win_rate)
