...
class Renderer:
    ...
    def draw_base_map(self, surf: Any) -> None:
        """Draw the base map."""
    ...
    def draw_units(self, surf: Any) -> None:  # noqa
        """Draw the units."""
        ...
        for u, p in self._get_units():
            ...
            def write_small(loc: Any, s: Any) -> None:
                surf.write_world(self._font_small, colors.white, loc, str(s))

            name = self.get_unit_name(
                surf, self.static_data.units.get(u.unit_type, "<none>"), u.radius
            )
                ...
                for o in u.orders:
                    ...
                    if o.HasField("target_unit_tag"):
                        if unit_dict is None:
                            unit_dict = {
                                t.tag: t for t in self.obs.observation.raw_data.units
                            }
    ...
    def draw_overlay(self, surf: Any) -> None:
    ...
    def draw_screen(self, surf: Any) -> None:
