...
@dataclass
class MAPGTrustRegionClippingPolicyLossConfig:
    clipping_epsilon: float = 0.2
    entropy_cost: float = 0.01


class MAPGWithTrustRegionClippingPolicyLoss(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingPolicyLossConfig = MAPGTrustRegionClippingPolicyLossConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
    ...
    def on_training_loss_fns(self, trainer: SystemTrainer) -> None:
        """Create and store MAPGWithTrustRegionClippingPolicyLossSeparateNetworks loss function.
...
@dataclass
class MAPGTrustRegionClippingValueLossConfig:
    value_clip_parameter: float = 0.2
    clip_value: bool = True
    value_cost: float = 0.5


class MAPGWithTrustRegionClippingValueLoss(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingValueLossConfig = MAPGTrustRegionClippingValueLossConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
...
@dataclass
class MAPGTrustRegionClippingValueHuberLossConfig:
    value_clip_parameter: float = 0.2
    clip_value: bool = True
    value_cost: float = 0.5


class MAPGWithTrustRegionClippingValueHuberLoss(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingValueHuberLossConfig = MAPGTrustRegionClippingValueHuberLossConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
