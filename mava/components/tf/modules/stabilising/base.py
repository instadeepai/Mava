...
"""Base stabilising interface for multi-agent RL systems"""


class BaseStabilisationModule:
    """Base class for MARL stabilising.
    ...
    def create_system(self) -> Dict[str, Dict[str, snt.Module]]:
        """Create system architecture with stabilisation."""
