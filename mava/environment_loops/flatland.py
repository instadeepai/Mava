...
"""A multi-agent/environment training loop for Flatland."""
import operator
import time
...
class FlatlandEnvironmentLoop(acme.core.Worker):
    """A Flatland RL environment loop.
    ...
    def __init__(
        self,
        environment: FlatlandEnvWrapper,
        executor: mava.core.Executor,
        counter: counting.Counter = None,
        logger: loggers.Logger = None,
        should_update: bool = True,
        label: str = "flatland_environment_loop",
    ):
