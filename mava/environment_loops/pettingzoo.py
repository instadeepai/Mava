...
from mava.environments.wrappers.pettingzoo import PettingZooWrapper


class PettingZooEnvironmentLoop(core.Worker):
    ...
    def _get_action(self, timestep: dm_env.TimeStep, agent_id: str) -> Any:
        return self._actors[agent_id].select_action(timestep.observation)
    ...
    def run_episode(self) -> loggers.LoggingData:
        ...
        while not timestep.last():
            ...
            for agent in self._environment.agent_iter(n_agents):
                ...
                self._actors[agent].observe(action, next_timestep=timestep)

                if self._should_update:
                    self._actors[agent].update()
