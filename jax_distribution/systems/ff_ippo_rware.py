...
def get_learner_fn(
    ...
    def _update_step(
        ...
        def _env_step(runner_state: RunnerState, _: Any) -> Tuple[RunnerState, PPOTransition]:
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                total_loss, grads = grad_fn(params, opt_state, traj_batch, advantages, targets)
                ...
                grads, total_loss = jax.lax.pmean((grads, total_loss), axis_name="batch")
                # pmean over devices.
                grads, total_loss = jax.lax.pmean((grads, total_loss), axis_name="device")
