...
def make_train(config):
    ...
    def train(rng):
        ...
        # )
        # TODO: Get action shape for single agent from Jumanji without tracer error.
        # idea for doing: env.action_spec().num_values[0].tolist()
        network = ActorCritic(4, activation=config["ACTIVATION"])
